...
export const campaigns: Campaign[] = [
  {
    ...
    status: "active",
    creatorBudgetMinor: 1_000_000,
    creatorBudgetSpentMinor: 258_000,
    ratePerMillionMinor: 50_000,
    maxPayoutPerAccountMinor: 25_000,
    maxPayoutPerVideoMinor: 20_000,
    maxSubmissionsPerAccount: 5,
    platformFeePercent: 10,
    requirements: {
      minVideoDurationSeconds: 15,
      maxVideoDurationSeconds: 45,
      minViews: 10000,
      minFollowers: 5000,
      videoLanguage: "en",
      specificAudience: false,
      requiredHashtag: "#stake",
    },
    promoMaterialsUrl: "https://drive.google.com/drive/folders/stake-highlights",
    ...
    optionalHashtags: ["#highlights", "#clips"],
    creators: 63,
    submissionsCount: 84,
    views: 5_100_000,
    exampleVideos: [
  ...
  },
  {
    ...
    status: "active",
    creatorBudgetMinor: 2_500_000,
    creatorBudgetSpentMinor: 912_000,
    ratePerMillionMinor: 75_000,
    maxPayoutPerAccountMinor: 50_000,
    maxPayoutPerVideoMinor: 35_000,
    maxSubmissionsPerAccount: 8,
    platformFeePercent: 10,
    requirements: {
      minVideoDurationSeconds: 20,
      maxVideoDurationSeconds: 40,
      minViews: 25000,
      minFollowers: 0,
      videoLanguage: "en",
      specificAudience: true,
      audienceDescription: "Counter-Strike / CS2 players and competitive gaming audience.",
      requiredHashtag: "#nexusplay",
    },
    promoMaterialsUrl: "https://drive.google.com/drive/folders/nexusplay-clips",
    platforms: ["tiktok", "youtube"],
    countries: ["United States", "Mexico", "Spain", "Brazil"],
    startDate: "Aug 20, 2026",
    endDate: "Oct 30, 2026",
    requiredCta: "Download NexusPlay",
    optionalHashtags: ["#gaming", "#clutch"],
    creators: 128,
  ...
  },
  {
    ...
    status: "active",
    creatorBudgetMinor: 500_000,
    creatorBudgetSpentMinor: 488_800,
    ratePerMillionMinor: 25_000,
    maxPayoutPerAccountMinor: 15_000,
    maxPayoutPerVideoMinor: 10_000,
    maxSubmissionsPerAccount: 10,
    platformFeePercent: 10,
    requirements: {
      minVideoDurationSeconds: 10,
      maxVideoDurationSeconds: 60,
      minViews: 5000,
      minFollowers: 0,
      videoLanguage: "any",
      specificAudience: false,
      requiredHashtag: "#neonskies",
    },
    promoMaterialsUrl: "https://www.dropbox.com/sh/riffrecords-neonskies",
    ...
    optionalHashtags: ["#riffrecords", "#newmusic"],
    creators: 96,
  ...
  },
  {
    ...
    status: "active",
    creatorBudgetMinor: 1_000_000,
    creatorBudgetSpentMinor: 421_000,
    ratePerMillionMinor: 100_000,
    maxPayoutPerAccountMinor: 40_000,
    maxPayoutPerVideoMinor: 30_000,
    maxSubmissionsPerAccount: 4,
    platformFeePercent: 10,
    requirements: {
      minVideoDurationSeconds: 25,
      maxVideoDurationSeconds: 60,
      minViews: 15000,
      minFollowers: 0,
      videoLanguage: "en",
      specificAudience: false,
      requiredHashtag: "#lumenai",
    },
    promoMaterialsUrl: "https://drive.google.com/drive/folders/lumen-ai-ugc",
    platforms: ["tiktok", "instagram", "youtube"],
    countries: ["United States", "United Kingdom", "Canada"],
    startDate: "Sep 5, 2026",
    endDate: "Oct 20, 2026",
    requiredCta: "Download Lumen AI",
    optionalHashtags: ["#aiapp", "#productivity"],
    creators: 71,
  ...
  },
  {
    ...
    status: "paused",
    creatorBudgetMinor: 1_500_000,
    creatorBudgetSpentMinor: 680_000,
    ratePerMillionMinor: 50_000,
    maxPayoutPerAccountMinor: 30_000,
    maxPayoutPerVideoMinor: 20_000,
    maxSubmissionsPerAccount: 6,
    platformFeePercent: 10,
    requirements: {
      minVideoDurationSeconds: 12,
      maxVideoDurationSeconds: 30,
      minViews: 20000,
      minFollowers: 0,
      videoLanguage: "en",
      specificAudience: false,
      requiredHashtag: "#apexsports",
    },
    promoMaterialsUrl: "https://drive.google.com/drive/folders/apex-sports",
    platforms: ["tiktok", "instagram", "youtube"],
    countries: ["United States", "Canada"],
    startDate: "Aug 1, 2026",
    endDate: "Sep 30, 2026",
    requiredCta: "Watch on Apex",
    optionalHashtags: ["#highlights", "#gameday"],
    creators: 54,
    submissionsCount: 97,
    views: 8_200_000,
    exampleVideos: [
...
export const creatorSocialAccounts: SocialAccount[] = [
  ...
  {
    // Instagram Personal: ownership via BIO challenge, metrics are manual.
    id: "sa4",
    platform: "instagram",
  ...
  {
    // Instagram Professional with an active API connection: automatic metrics.
    id: "sa5",
    platform: "instagram",
    handle: "@shortsterbusiness",
    displayName: "Shortster Business",
    followers: 76800,
    method: "oauth",
    status: "verified",
    ownershipStatus: "verified",
  ...
  {
    // Connection lost — this is the only account that surfaces a Reconnect action.
    id: "sa6",
    platform: "youtube",
    handle: "Shortster Shorts",
    displayName: "Shortster Shorts",
    followers: 31200,
    method: "google",
    status: "revoked",
    ownershipStatus: "verified",
...
export const creatorSubmissions: Submission[] = [
  ...
  },
  {
    ...
    duration: 31,
    ratePerMillionMinor: 75_000,
    calculatedRewardMinor: 38_430,
    finalRewardMinor: 35_000,
    status: "approved",
  ...
  },
  {
    id: "sub-1043",
    metricsMode: "manual",
    metricsSource: "manual_creator_proof",
    claimedViews: 88420,
    proofAssets: ["/campaigns/ai-app-ugc.png"],
  ...
  },
  {
    ...
    duration: 27,
    ratePerMillionMinor: 50_000,
    calculatedRewardMinor: 17_145,
    finalRewardMinor: 20_000,
    status: "credited",
...
export const moderationQueue: Submission[] = [
  ...
  },
  {
    ...
    metricsSource: "manual_creator_proof",
    claimedViews: 97800,
    proofAssets: ["/campaigns/music-promotion.png"],
    campaignId: "music-promotion",
    campaignTitle: "Music Promotion",
    brand: "Riff Records",
    cover: "/campaigns/music-promotion.png",
...
export const creatorTransactions: WalletTransaction[] = [
  { id: "tx-9001", date: "Sep 19, 2026", type: "Creator Reward", description: "Stake Highlights", amountMinor: 9_215, status: "completed", reference: "SUB-1041", campaign: "Stake Highlights", submission: "sub-1041" },
  { id: "tx-9002", date: "Sep 15, 2026", type: "Creator Reward", description: "Stake Highlights", amountMinor: 20_000, status: "completed", reference: "SUB-1045", campaign: "Stake Highlights", submission: "sub-1045" },
  { id: "tx-9003", date: "Sep 12, 2026", type: "Withdrawal", description: "Payout to USDT wallet", amountMinor: -50_000, status: "completed", reference: "WD-3120" },
  { id: "tx-9004", date: "Sep 8, 2026", type: "Creator Reward", description: "Gaming Clips", amountMinor: 12_840, status: "completed", reference: "SUB-1030", campaign: "Gaming Clips" },
  { id: "tx-9005", date: "Sep 5, 2026", type: "Adjustment", description: "Goodwill credit", amountMinor: 1_500, status: "completed", reference: "ADJ-221" },
  { id: "tx-9006", date: "Sep 2, 2026", type: "Creator Reward", description: "AI App UGC", amountMinor: 8_842, status: "pending", reference: "SUB-1043", campaign: "AI App UGC", submission: "sub-1043" },
]

export const creatorEarningsSeries = [
  { month: "Apr", earningsMinor: 82_000 },
  { month: "May", earningsMinor: 124_000 },
  { month: "Jun", earningsMinor: 168_000 },
  { month: "Jul", earningsMinor: 214_000 },
  { month: "Aug", earningsMinor: 298_000 },
  { month: "Sep", earningsMinor: 376_000 },
]

// ADVERTISER
export const advertiserWallet: AdvertiserWallet = {
  availableMinor: 1_500_000,
  reservedCreatorBudgetMinor: 1_000_000,
  reservedPlatformFeeMinor: 100_000,
  totalDepositedMinor: 4_500_000,
  totalSpentMinor: 2_483_000,
}

export const advertiserTransactions: WalletTransaction[] = [
  { id: "atx-5001", date: "Sep 18, 2026", type: "Deposit", description: "Wire transfer", amountMinor: 2_000_000, status: "completed", reference: "DEP-8801" },
  { id: "atx-5002", date: "Sep 10, 2026", type: "Campaign Reserve", description: "Stake Highlights budget", amountMinor: -1_000_000, status: "completed", reference: "RES-4410", campaign: "Stake Highlights" },
  { id: "atx-5003", date: "Sep 15, 2026", type: "Campaign Spend", description: "Stake Highlights payouts", amountMinor: -258_000, status: "completed", reference: "SPD-4419", campaign: "Stake Highlights" },
  { id: "atx-5004", date: "Sep 12, 2026", type: "Refund", description: "Rejected submission reversal", amountMinor: 4_600, status: "completed", reference: "REF-2201" },
  { id: "atx-5005", date: "Sep 2, 2026", type: "Deposit", description: "Credit card", amountMinor: 2_500_000, status: "completed", reference: "DEP-8720" },
]

export const advertiserStatsSeries = [
  { day: "Sep 12", views: 420000, spendMinor: 21_000, submissions: 8 },
  { day: "Sep 13", views: 680000, spendMinor: 34_000, submissions: 12 },
  { day: "Sep 14", views: 540000, spendMinor: 27_000, submissions: 9 },
  { day: "Sep 15", views: 910000, spendMinor: 45_500, submissions: 15 },
  { day: "Sep 16", views: 1200000, spendMinor: 60_000, submissions: 21 },
  { day: "Sep 17", views: 980000, spendMinor: 49_000, submissions: 17 },
  { day: "Sep 18", views: 1370000, spendMinor: 68_500, submissions: 24 },
]
...
export const notifications: Notification[] = [
  { id: "n1", title: "Submission approved", detail: "Stake Highlights", time: "2m ago", kind: "success", amountMinor: 9_215, read: false },
  ...
  { id: "n5", title: "Withdrawal completed", detail: "$500.00 to USDT wallet", time: "2d ago", kind: "success", amountMinor: 50_000, read: true },
]

export const adminUsers: AdminUser[] = [
  { id: "u1", name: "Alex Rivera", handle: "@shortster", role: "creator", status: "active", joined: "Aug 12, 2026", earningsMinor: 1_482_040 },
  { id: "u2", name: "Mia Chen", handle: "@miaclips", role: "creator", status: "active", joined: "Jul 3, 2026", earningsMinor: 2_841_000 },
  { id: "u3", name: "Stake", handle: "@stake", role: "advertiser", status: "active", joined: "Jun 20, 2026", spendMinor: 8_420_000 },
  { id: "u4", name: "NexusPlay", handle: "@nexusplay", role: "advertiser", status: "active", joined: "Jul 15, 2026", spendMinor: 5_210_000 },
  { id: "u5", name: "Jordan Lee", handle: "@techtok", role: "creator", status: "suspended", joined: "Sep 1, 2026", earningsMinor: 21_000 },
  { id: "u6", name: "Taylor Brooks", handle: "@taylormod", role: "moderator", status: "active", joined: "May 10, 2026" },
  { id: "u7", name: "Dani Vasquez", handle: "@daniedits", role: "creator", status: "pending", joined: "Sep 16, 2026", earningsMinor: 0 },
]

export const adminTransactions: WalletTransaction[] = [
  { id: "adm-tx1", date: "Sep 19, 2026", type: "Campaign Spend", description: "Stake → Alex Rivera", amountMinor: -9_215, status: "completed", reference: "SPD-9001", campaign: "Stake Highlights" },
  { id: "adm-tx2", date: "Sep 18, 2026", type: "Deposit", description: "Stake wallet top-up", amountMinor: 2_000_000, status: "completed", reference: "DEP-8801" },
  { id: "adm-tx3", date: "Sep 18, 2026", type: "Withdrawal", description: "Mia Chen → Bank", amountMinor: -120_000, status: "pending", reference: "WD-3125" },
  { id: "adm-tx4", date: "Sep 17, 2026", type: "Campaign Reserve", description: "NexusPlay budget", amountMinor: -2_500_000, status: "completed", reference: "RES-4501", campaign: "Gaming Clips" },
  { id: "adm-tx5", date: "Sep 16, 2026", type: "Refund", description: "Rejected submission reversal", amountMinor: 4_600, status: "completed", reference: "REF-2201" },
]

export const adminWithdrawals: WalletTransaction[] = [
  { id: "wd-1", date: "Sep 18, 2026", type: "Withdrawal", description: "Mia Chen → USDT (Tron)", amountMinor: -120_000, status: "pending", reference: "WD-3125" },
  { id: "wd-2", date: "Sep 12, 2026", type: "Withdrawal", description: "Alex Rivera → USDC (Ethereum)", amountMinor: -50_000, status: "completed", reference: "WD-3120" },
  { id: "wd-3", date: "Sep 5, 2026", type: "Withdrawal", description: "Sam Okafor → USDT (BSC)", amountMinor: -82_000, status: "completed", reference: "WD-3101" },
]
...
export const adminStatsSeries = [
  { month: "Apr", gmvMinor: 4_200_000, revenueMinor: 420_000 },
  { month: "May", gmvMinor: 5_800_000, revenueMinor: 580_000 },
  { month: "Jun", gmvMinor: 7_100_000, revenueMinor: 710_000 },
  { month: "Jul", gmvMinor: 9_400_000, revenueMinor: 940_000 },
  { month: "Aug", gmvMinor: 11_800_000, revenueMinor: 1_180_000 },
  { month: "Sep", gmvMinor: 14_200_000, revenueMinor: 1_420_000 },
]

export const creatorWallet: CreatorWallet = {
  availableMinor: 128_425,
  pendingMinor: 38_410,
  lifetimeMinor: 1_482_040,
}

// Creator starts with NO payout method configured so the "Add Payout Method"
// (crypto wallet) flow is demonstrable. Adding one produces a USDC wallet example.
